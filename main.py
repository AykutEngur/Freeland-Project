...
def registration_form():
    with st.form(key="signup", clear_on_submit=True):
        ...
        agree = st.checkbox("I agree to the License & User Agreement, which ensures that my data is secure and private.")
...
def home_page():
    with st.sidebar:
        ...
        selected = option_menu("Home Page", 
                       ...
                       icons=['eye', 'pencil','filter', 'star', 'envelope', 'user' ,'search', 'info'], 
                       menu_icon="cast", 
                       default_index=0,
                       styles={
